...
for(test.fold in 1:n.folds){
  is.test <- fold.vec == test.fold
    ...
    plot(sqr.loss.vec)
    sqr.loss.vec
    early.stop.list <- linearmodels:: LMSquareLossEarlyStoppingCV(x.train,y.train,fold.vec,30)
    square.loss <- linearmodels:: LMSquareLossL2penalties(x.train, y.train, penalty.vec)
