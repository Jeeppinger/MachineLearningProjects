...
<p>By observing our results, we can see that something did go wrong with our code since the Train and Validation set are Identical to each other. This could be something we could debug to fix later on.</p>
